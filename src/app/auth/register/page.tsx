    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-500">One human, one account. Create yours below.</p>
        </div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-gray-400">
                Used for identity verification. One phone number per account.
              </p>
            </div>
          ...
          <div className="mt-5 rounded-xl bg-indigo-50 border border-indigo-100 px-4 py-3">
            <div className="flex gap-2">
              <svg
                className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth={1.5}
                stroke="currentColor"
              ...
              <p className="text-xs text-indigo-700 leading-relaxed">
                <strong>One Human, One Account:</strong> Our Place requires each person to have
                exactly one account. Your email and phone number are used to verify your unique

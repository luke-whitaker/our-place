          ...
          {photos.map((photo, idx) => (
            <div key={idx} className="group relative aspect-square overflow-hidden rounded-lg">
              ...
              <button
                ...
                className="absolute right-1 top-1 rounded-full bg-black/50 p-0.5 text-ink-inverse opacity-0 transition-opacity group-hover:opacity-100 hover:bg-black/70"
              >
                <svg

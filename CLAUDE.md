...
4. **Short functions.** One logical unit, roughly 60 lines or fewer. Component logic stays under about 60 lines; extract subcomponents when the JSX stops fitting on a screen. A function that needs section comments to navigate should be split.
